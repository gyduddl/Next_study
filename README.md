...
* **해결:** 1. Next.js의 **Route Handler(`app/api/location/route.ts`)**를 구축하여 API 키를 서버 환경 변수(`.env`)로 격리.<br>
  2. 카카오 로컬 API를 서버에서 호출하여 좌표를 한글 주소로 변환하는 **Reverse Geocoding** 로직 구현.<br>
